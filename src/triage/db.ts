...
// Triage schema inlined so the bundled dist doesn't need the migrations/
// directory at runtime. (Prior version computed a relative path via
// import.meta.url which broke when tsdown collapsed src/triage/db.ts +
// every other module into dist/entry.js — the `../../migrations/...`
// step went up too many levels and ENOENT'd every triage DB open.)
const TRIAGE_SCHEMA_SQL = `
