...
import { Gt as DEFAULT_PROVIDER, f as resolveAllowlistModelKey } from "./model-selection-ynGV0Z-S.js";
import { n as fetchWithTimeout } from "./fetch-timeout-Db3da8yR.js";
import { St as ZAI_GLOBAL_BASE_URL, bt as ZAI_CODING_CN_BASE_URL, xt as ZAI_CODING_GLOBAL_BASE_URL, yt as ZAI_CN_BASE_URL } from "./auth-token-Tf6ZJ0Dn.js";
...
const ZAI_GENERAL_PROBE_MODEL_IDS = [
	"glm-5-turbo",
	"glm-5.1",
	"glm-5"
];
...
async function detectZaiEndpoint(params) {
	...
	for (const candidate of generalEndpoints) for (const modelId of ZAI_GENERAL_PROBE_MODEL_IDS) if ((await probeZaiChatCompletions({
		...
		if (modelId === "glm-5") note += " API id glm-5 is deprecated after 2026-04-20; prefer glm-5-turbo or glm-5.1.";
		return {
