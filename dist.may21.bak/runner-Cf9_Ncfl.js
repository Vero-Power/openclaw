import { G as logVerbose, J as shouldLogVerbose } from "./registry-Bvgaapvc.js";
import { T as runExec } from "./agent-scope-BgCF8o1F.js";
import { G as resolveOpenClawAgentDir, T as resolveApiKeyForProvider, c as normalizeProviderId, h as normalizeGoogleModelId, w as requireApiKey } from "./model-selection-DAWW2H4n.js";
import { t as normalizeChatType } from "./chat-type-DFDuk3FY.js";
import { f as getFileExtension, g as kindFromMime, m as isAudioFileName, u as detectMime } from "./fs-safe-EcGbY0tj.js";
import { d as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, f as isInboundPathAllowed, m as resolveIMessageAttachmentRoots, n as loadConfig, p as mergeInboundPathRoots } from "./config-BhzpX3F8.js";
import { S as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-RAevccOK.js";
import { n as collectProviderApiKeysForExecution, r as executeWithApiKeyRotation, t as parseGeminiAuth } from "./gemini-auth-CGQlnaPp.js";
import { n as fetchWithTimeout } from "./fetch-timeout-CIqp9OvD.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, o as fetchWithSsrFGuard, r as MediaFetchError } from "./local-roots-HZSoZq6A.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-CCQEM1-m.js").then((n) => n.r);
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-WToSWA_8.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
