...
import { h as GATEWAY_CLIENT_NAMES, m as GATEWAY_CLIENT_MODES, p as GATEWAY_CLIENT_IDS } from "./message-channel-mz9U3AFl.js";
import { p as rawDataToString, r as isSecureWebSocketUrl } from "./net-COi3RSq7.js";
...
*/
function isPairingRequiredCloseReason(reason) {
...
*/
function formatGatewayPairingRequiredError(reason) {
	return [
		`gateway closed (1008 policy violation): ${reason?.trim() || "pairing required"}`,
		"",
...
var GatewayClient = class {
	...
	start() {
		...
		this.ws.on("close", (code, reason) => {
			...
			const closeMessage = code === 1008 && isPairingRequiredCloseReason(reasonText) ? formatGatewayPairingRequiredError(reasonText) : `gateway closed (${code}): ${reasonText}`;
...
//#endregion
export { validateNodePairApproveParams as $, validateCronRunParams as A, validateWizardStatusParams as At, validateExecApprovalRequestParams as B, loadOrCreateDeviceIdentity as Bt, validateConfigPatchParams as C, validateUpdateRunParams as Ct, validateCronAddParams as D, validateWizardCancelParams as Dt, validateConnectParams as E, validateWebLoginWaitParams as Et, validateDevicePairListParams as F, parseSessionLabel as Ft, validateExecApprovalsSetParams as G, validateExecApprovalsGetParams as H, verifyDeviceSignature as Ht, validateDevicePairRejectParams as I, buildDeviceAuthPayload as It, validateNodeDescribeParams as J, validateLogsTailParams as K, validateDevicePairRemoveParams as L, normalizeDeviceAuthScopes as Lt, validateCronStatusParams as M, ErrorCodes as Mt, validateCronUpdateParams as N, errorShape as Nt, validateCronListParams as O, validateWizardNextParams as Ot, validateDevicePairApproveParams as P, SESSION_LABEL_MAX_LENGTH as Pt, validateNodeListParams as Q, validateDeviceTokenRevokeParams as R, normalizeFingerprint as Rt, validateConfigGetParams as S, validateTalkModeParams as St, validateConfigSetParams as T, validateWebLoginStartParams as Tt, validateExecApprovalsNodeGetParams as U, validateExecApprovalResolveParams as V, normalizeDevicePublicKeyBase64Url as Vt, validateExecApprovalsNodeSetParams as W, validateNodeInvokeParams as X, validateNodeEventParams as Y, validateNodeInvokeResultParams as Z, validateChatAbortParams as _, validateSkillsBinsParams as _t, validateAgentIdentityParams as a, validatePollParams as at, validateChatSendParams as b, validateSkillsUpdateParams as bt, validateAgentsCreateParams as c, validateSendParams as ct, validateAgentsFilesListParams as d, validateSessionsListParams as dt, validateNodePairListParams as et, validateAgentsFilesSetParams as f, validateSessionsPatchParams as ft, validateChannelsStatusParams as g, validateSessionsUsageParams as gt, validateChannelsLogoutParams as h, validateSessionsResolveParams as ht, formatValidationErrors as i, validateNodeRenameParams as it, validateCronRunsParams as j, PROTOCOL_VERSION as jt, validateCronRemoveParams as k, validateWizardStartParams as kt, validateAgentsDeleteParams as l, validateSessionsCompactParams as lt, validateAgentsUpdateParams as m, validateSessionsResetParams as mt, formatGatewayPairingRequiredError as n, validateNodePairRequestParams as nt, validateAgentParams as o, validatePushTestParams as ot, validateAgentsListParams as p, validateSessionsPreviewParams as pt, validateModelsListParams as q, isPairingRequiredCloseReason as r, validateNodePairVerifyParams as rt, validateAgentWaitParams as s, validateRequestFrame as st, GatewayClient as t, validateNodePairRejectParams as tt, validateAgentsFilesGetParams as u, validateSessionsDeleteParams as ut, validateChatHistoryParams as v, validateSkillsInstallParams as vt, validateConfigSchemaParams as w, validateWakeParams as wt, validateConfigApplyParams as x, validateTalkConfigParams as xt, validateChatInjectParams as y, validateSkillsStatusParams as yt, validateDeviceTokenRotateParams as z, deriveDeviceIdFromPublicKey as zt };