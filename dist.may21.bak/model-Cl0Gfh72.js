...
import { Pt as resolveOpenClawAgentDir, Ut as DEFAULT_CONTEXT_TOKENS, l as normalizeProviderId } from "./model-selection-ynGV0Z-S.js";
...
function isZaiGlm5SeriesModelId(lower) {
	return lower === "glm-5" || lower.startsWith("glm-5.") || lower.startsWith("glm-5-") || lower.startsWith("glm-5v");
}
...
function resolveZaiGlm5ForwardCompatModel(provider, modelId, modelRegistry) {
	...
	if (!isZaiGlm5SeriesModelId(lower)) return;
