import { At as getResolvedLoggerSettings, Pt as CONFIG_PATH, Ut as resolveGatewayPort, Wt as resolveIsNixMode, Yt as resolveStateDir, _ as defaultRuntime, fn as resolveRequiredHomeDir, lt as shortenHomePath, n as isTruthyEnvValue, ot as resolveUserPath, qt as resolveOAuthDir, ut as sleep } from "./entry.js";
import { Gt as CODEX_CLI_PROFILE_ID, Ht as DEFAULT_PROVIDER, N as getModelRefStatus, S as updateAuthProfileStoreWithLock, U as resolveHooksGmailModel, V as resolveConfiguredModelRef, Vt as DEFAULT_MODEL, Wt as CLAUDE_CLI_PROFILE_ID, b as ensureAuthProfileStore, bt as resolveApiKeyForProvider, c as resolveApiKeyForProfile, p as repairOAuthProfileIdMismatch, s as resolveProfileUnusableUntilForDisplay } from "./auth-profiles-CiQsARKp.js";
...
import { c as resolveAgentWorkspaceDir, i as resolveAgentDir, l as resolveDefaultAgentId, p as DEFAULT_AGENTS_FILENAME } from "./agent-scope-BEB0yS_L.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-DG_-cls5.js";
import { l as writeConfigFile, o as readConfigFileSnapshot } from "./config-BZ-sQEmh.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-CUYAxKYv.js";
import { l as resolveGatewayBindHost, n as isLoopbackHost } from "./net-COi3RSq7.js";
import { an as DEFAULT_OAUTH_WARN_MS, g as loadOpenClawPlugins, on as buildAuthHealthSummary, sn as formatRemainingShort } from "./subagent-registry-vEaOpKkF.js";
import { B as cleanStaleLockFiles, N as resolveMainSessionKey, a as loadSessionStore } from "./sessions-DR2Q7emK.js";
import { n as listChannelPlugins } from "./plugins-skOiRwEk.js";
import { D as DEFAULT_SANDBOX_IMAGE, E as DEFAULT_SANDBOX_COMMON_IMAGE, T as DEFAULT_SANDBOX_BROWSER_IMAGE, f as resolveSandboxScope } from "./sandbox-DHahf6kq.js";
import { i as resolveGatewayAuth } from "./auth-Usar6LvN.js";
import { i as formatPortDiagnostics, n as inspectPortUsage } from "./ports-Dq8ogiz4.js";
import { c as resolveStorePath, n as resolveSessionFilePath, s as resolveSessionTranscriptsDirForAgent } from "./paths-CHiHHmOl.js";
import { i as resolveMemoryBackendConfig } from "./memory-cli-Cus9od3R.js";
import { n as resolveMemorySearchConfig } from "./manager-WV9Ukl3R.js";
...
import { h as randomToken, n as applyWizardMetadata, p as printWizardHeader, s as guardCancel } from "./onboard-helpers-1IVAZXr5.js";
import { n as isWSLEnv, t as isWSL } from "./wsl-UvJ5dHah.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-D7sAEM59.js";
import { t as note$1 } from "./note-BJVGNRX7.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-Q0PwR_xb.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-CkhMsCbV.js";
import { a as gatewayInstallErrorHint, f as renderSystemNodeWarning, i as buildGatewayInstallPlan, m as resolveSystemNodeInfo, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-yCUgVLDr.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-BaLni5Pb.js";
import { a as launchAgentPlistExists, i as isLaunchAgentLoaded, o as repairLaunchAgentBootstrap, r as isLaunchAgentListed, s as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-CSCumKJX.js";
import { i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as formatRuntimeStatus, t as isSystemdUnavailableDetail } from "./systemd-hints-D3ovjVua.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-DmGaiRdO.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-BIp_zmgz.js";
import { r as healthCommand } from "./health-BOYHVZ3d.js";
import { n as resolveControlUiDistIndexHealth, r as resolveControlUiDistIndexPathForRoot } from "./control-ui-assets-CEq_Smds.js";
import { t as resolveDmAllowState } from "./dm-policy-shared-BorWOZ4P.js";
...
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-S8bPW61I.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-oDj-p-JT.js";
import { t as formatHealthCheckFailure } from "./health-format-DkjSgkDx.js";
import { n as doctorShellCompletion } from "./doctor-completion-CN4K2WgR.js";
