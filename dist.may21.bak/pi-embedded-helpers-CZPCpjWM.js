...
import { n as resolveAgentConfig, u as resolveSessionAgentId } from "./agent-scope-tDSbswwo.js";
import { r as defaultRuntime, t as createSubsystemLogger } from "./subsystem-B5g771Td.js";
import { _ as runExec, a as DEFAULT_IDENTITY_FILENAME, c as DEFAULT_USER_FILENAME, i as DEFAULT_HEARTBEAT_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_AGENT_WORKSPACE_DIR, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_BOOTSTRAP_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-Dk7qkKmf.js";
import { J as isPidAlive, q as resolveProcessScopedMap } from "./model-selection-BymXpuGc.js";
import { n as formatCliCommand } from "./env-DQUuhEFy.js";
import { t as parseBooleanValue } from "./boolean-B8-BqKGQ.js";
import { t as normalizeChatType } from "./chat-type-C4pAlbsI.js";
import { r as normalizeChannelId } from "./plugins-BCKDArtV.js";
import { i as buildImageResizeSideGrid, l as resizeToJpeg, o as getImageMetadata, r as IMAGE_REDUCE_QUALITY_STEPS } from "./fs-safe-D_arMs0S.js";
import { o as listDeliverableMessageChannels, s as normalizeMessageChannel } from "./message-channel-BDlvrUZF.js";
import { _ as parseDurationMs, a as writeConfigFile, n as loadConfig, s as parseByteSize, t as createConfigIO } from "./config-CUdAlGKZ.js";
import { d as sanitizeContentBlocksImages, u as wrapOwnerOnlyToolExecution } from "./common-B42CZ6Du.js";
import { A as DEFAULT_AI_SNAPSHOT_MAX_CHARS, F as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, M as DEFAULT_BROWSER_EVALUATE_ENABLED, N as DEFAULT_OPENCLAW_BROWSER_COLOR, O as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, P as DEFAULT_OPENCLAW_BROWSER_ENABLED, S as stopChromeExtensionRelayServer, _ as fetchJson, a as resolveOpenClawUserDataDir, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, g as appendCdpPath, h as withBrowserNavigationPolicy, i as launchOpenClawChrome, j as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, k as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, l as createTargetViaCdp, m as assertBrowserNavigationAllowed, n as isChromeCdpReady, o as stopOpenClawChrome, p as InvalidBrowserNavigationUrlError, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as fetchOk, w as isLoopbackHost, x as ensureChromeExtensionRelayServer } from "./chrome-BL-05-L_.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, u as resolveSandboxPath } from "./skills-mtulzV5-.js";
...
import { r as saveMediaBuffer, t as ensureMediaDir } from "./store-D1jTTPiR.js";
import { d as getChannelDock, o as normalizeThinkLevel, v as normalizeHyphenSlug } from "./thinking-BUgeNpj0.js";
import { n as resolveConversationLabel } from "./conversation-label-CVfE-2PQ.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-HQhQTk76.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-HQhQTk76.js")).closePlaywrightBrowserConnection();
		} catch {}
...
//#endregion
export { normalizeAccountId as $, isTransientHttpError as A, getBridgeAuthForPort as At, loadSessionStore as B, normalizeToolName as Bt, isContextOverflowError as C, resolveSessionLockMaxHoldFromTimeout as Ct, isRateLimitAssistantError as D, resolveProfile as Dt, isLikelyContextOverflowError as E, resolveBrowserConfig as Et, resolveSandboxContext as F, buildPluginToolGroups as Ft, updateSessionStoreEntry as G, buildBootstrapContextFiles as Gt, recordSessionMetaFromInbound as H, stripPluginOnlyAllowlist as Ht, resolveSandboxRuntimeStatus as I, collectExplicitAllowlist as It, deliveryContextFromSession as J, resolveBootstrapTotalMaxChars as Jt, isCacheEnabled as K, ensureSessionHeader$1 as Kt, extractDeliveryInfo as L, expandPolicyWithPluginGroups as Lt, parseImageSizeError as M, resolveBrowserControlAuth as Mt, sanitizeUserFacingText as N, resolveSandboxConfigForAgent as Nt, isRawApiErrorPayload as O, DEFAULT_UPLOAD_DIR as Ot, ensureSandboxWorkspaceForSession as P, applyOwnerOnlyToolPolicy as Pt, normalizeSessionDeliveryFields as Q, appendAssistantMessageToSessionTranscript as R, expandToolGroups as Rt, isCompactionFailureError as S, acquireSessionWriteLock as St, isFailoverErrorMessage as T, registerBrowserRoutes as Tt, updateLastRoute as U, compileGlobPatterns as Ut, readSessionUpdatedAt as V, resolveToolProfilePolicy as Vt, updateSessionStore as W, matchesAnyGlobPattern as Wt, mergeDeliveryContext as X, deliveryContextKey as Y, sanitizeGoogleTurnOrdering as Yt, normalizeDeliveryContext as Z, formatRawAssistantErrorForUi as _, resolveAgentMainSessionKey as _t, isMessagingToolDuplicateNormalized as a, applyInputProvenanceToUserMessage as at, isBillingAssistantError as b, deriveSessionMetaPatch as bt, extractToolCallsFromAssistant as c, resolveSessionKey as ct, isAntigravityClaude as d, resolveSessionResetPolicy as dt, archiveSessionTranscripts as et, isGoogleModelApi as f, resolveSessionResetType as ft, formatBillingErrorMessage as g, canonicalizeMainSessionAlias as gt, formatAssistantErrorText as h, resolveFreshSessionTotalTokens as ht, isMessagingToolDuplicate as i, INPUT_PROVENANCE_KIND_VALUES as it, parseImageDimensionError as j, ensureBrowserControlAuth as jt, isTimeoutErrorMessage as k, resolvePathsWithinRoot as kt, extractToolResultId as l, evaluateSessionFreshness as lt, classifyFailoverReason as m, DEFAULT_RESET_TRIGGERS as mt, validateGeminiTurns as n, countToolResults as nt, normalizeTextForComparison as o, hasInterSessionUserProvenance as ot, BILLING_ERROR_USER_MESSAGE as p, resolveThreadFlag as pt, resolveCacheTtlMs as q, resolveBootstrapMaxChars as qt, pickFallbackThinkingLevel as r, extractToolCallNames as rt, sanitizeSessionMessagesImages as s, normalizeInputProvenance as st, validateAnthropicTurns as t, capArrayByJsonBytes as tt, downgradeOpenAIReasoningBlocks as u, resolveChannelResetConfig as ut, getApiErrorPayloadFingerprint as v, resolveExplicitAgentSessionKey as vt, isFailoverAssistantError as w, createBrowserRouteContext as wt, isCloudCodeAssistFormatError as x, resolveGroupSessionKey as xt, isAuthAssistantError as y, resolveMainSessionKey as yt, resolveMirroredTranscriptText as z, mergeAlsoAllowPolicy as zt };