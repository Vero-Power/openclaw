import { A as VENICE_BASE_URL, B as buildSyntheticModelDefinition, C as buildQianfanProvider, Dt as upsertAuthProfile, F as TOGETHER_MODEL_CATALOG, I as buildTogetherModelDefinition, L as SYNTHETIC_BASE_URL, M as VENICE_MODEL_CATALOG, N as buildVeniceModelDefinition, P as TOGETHER_BASE_URL, Pt as resolveOpenClawAgentDir, R as SYNTHETIC_DEFAULT_MODEL_REF, S as XIAOMI_DEFAULT_MODEL_ID, b as QIANFAN_BASE_URL, ct as buildCloudflareAiGatewayModelDefinition, it as buildHuggingfaceModelDefinition, j as VENICE_DEFAULT_MODEL_REF, l as normalizeProviderId, lt as resolveCloudflareAiGatewayBaseUrl, nt as HUGGINGFACE_BASE_URL, rt as HUGGINGFACE_MODEL_CATALOG, st as CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF, w as buildXiaomiProvider, x as QIANFAN_DEFAULT_MODEL_ID, z as SYNTHETIC_MODEL_CATALOG } from "./model-selection-ynGV0Z-S.js";
...
const ZAI_DEFAULT_MODEL_ID = "glm-5-turbo";
...
function buildZaiModelDefinition(params) {
	...
	const defaultInput = params.id === "glm-5v-turbo" ? ["text", "image"] : ["text"];
	return {
		id: params.id,
...
const ZAI_DEFAULT_MODEL_REF = "zai/glm-5-turbo";
