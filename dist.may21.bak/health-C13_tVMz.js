...
import { $n as stripHeartbeatToken, B as resolveHeartbeatSenderContext, Dt as setHeartbeatWakeHandler, Et as requestHeartbeatNow, Jn as CommandLane, On as resolveUserTimezone, Ot as resolveHeartbeatReasonKind, Qn as resolveHeartbeatPrompt$1, Un as getQueueSize, Xn as DEFAULT_HEARTBEAT_EVERY, Yn as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, Zn as isHeartbeatContentEffectivelyEmpty, dr as peekSystemEventEntries, r as appendCronStyleCurrentTimeLine, t as getReplyFromConfig, z as resolveHeartbeatDeliveryTarget } from "./reply-DWT0cy8-.js";
...
import { c as resolveAgentWorkspaceDir, g as DEFAULT_HEARTBEAT_FILENAME, l as resolveDefaultAgentId, r as resolveAgentConfig } from "./agent-scope-BZLOCEiY.js";
...
import { L as canonicalizeMainSessionAlias, R as resolveAgentMainSessionKey, a as loadSessionStore, c as saveSessionStore, u as updateSessionStore } from "./sessions-CVkx1N0P.js";
import { a as resolvePreferredAccountId, t as buildChannelAccountBindings } from "./bindings-CR1uT82M.js";
...
import { t as HEARTBEAT_TOKEN } from "./tokens--IQBlVdq.js";
import { t as deliverOutboundPayloads } from "./deliver-ByBbvbQg.js";
import { o as resolveEffectiveMessagesConfig } from "./reply-prefix-BlvINWyz.js";
...
import { a as resolveIndicatorType, n as emitHeartbeatEvent, o as resolveHeartbeatReplyPayload, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-JgoQYZHO.js";
...
async function resolveHeartbeatPreflight(params) {
	...
	try {
		if (isHeartbeatContentEffectivelyEmpty(await fs.readFile(heartbeatFilePath, "utf-8")) && !shouldBypassFileGates) return {
			...reasonFlags,
			session,
			pendingEventEntries,
			hasTaggedCronEvents,
		...
		if (err?.code === "ENOENT" && !shouldBypassFileGates) return {
			...reasonFlags,
			session,
			pendingEventEntries,
			hasTaggedCronEvents,
