import { Pt as resolveOpenClawAgentDir } from "./model-selection-ynGV0Z-S.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-Cfth2R6s.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
