...
import { Et as getShellEnvAppliedKeys, F as modelKey, H as resolveDefaultModelForAgent, Ht as DEFAULT_PROVIDER, L as normalizeProviderId, M as findNormalizedProviderValue, R as parseModelRef, St as resolveEnvApiKey, T as resolveOpenClawAgentDir, Ut as resolveAuthProfileDisplayLabel, V as resolveConfiguredModelRef, Vt as DEFAULT_MODEL, W as resolveModelRefFromString, _ as setAuthProfileOrder, b as ensureAuthProfileStore, bt as resolveApiKeyForProvider, h as listProfilesForProvider, j as buildModelAliasIndex, jt as shouldEnableShellEnvFallback, n as resolveAuthProfileOrder, s as resolveProfileUnusableUntilForDisplay, v as upsertAuthProfile, vt as getCustomProviderApiKey, w as resolveAuthStorePathForDisplay, xt as resolveAwsSdkEnvVarName } from "./auth-profiles-CiQsARKp.js";
import { t as formatCliCommand } from "./command-format-Cutkv9UT.js";
import { D as resolveDefaultAgentWorkspaceDir, a as resolveAgentModelFallbacksOverride, c as resolveAgentWorkspaceDir, i as resolveAgentDir, l as resolveDefaultAgentId, o as resolveAgentModelPrimary } from "./agent-scope-BEB0yS_L.js";
import { t as ensurePiAuthJsonFromAuthProfiles } from "./pi-auth-json-Di-QoSPp.js";
import { i as resolveForwardCompatModel, r as ANTIGRAVITY_OPUS_46_FORWARD_COMPAT_CANDIDATES } from "./model-Db-28JMH.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-Do3xMEtM.js";
import { C as parseDurationMs, i as loadConfig } from "./config-BZ-sQEmh.js";
import { Kt as formatUsageWindowSummary, Wt as loadProviderUsageSummary, an as DEFAULT_OAUTH_WARN_MS, in as maskApiKey, on as buildAuthHealthSummary, qt as resolveUsageProviderId, rt as describeFailoverError, s as runEmbeddedPiAgent, sn as formatRemainingShort } from "./subagent-registry-vEaOpKkF.js";
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-CHiHHmOl.js";
import { t as ensureOpenClawModelsJson } from "./models-config-JLYhU63Q.js";
import { n as loadModelCatalog } from "./model-catalog-pRYheRY6.js";
import { r as withProgressTotals } from "./progress-Clpi3Ckj.js";
import { f as openUrl } from "./onboard-helpers-1IVAZXr5.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-D7sAEM59.js";
import { t as createClackPrompter } from "./clack-prompter-BnC48P20.js";
...
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-CWLcSjGl.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-XPJxK1yb.js";
import { n as logConfigUpdated } from "./logging-BGewRZy0.js";
import { a as createVpsAwareOAuthHandlers, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-Cp03x53X.js";
...
async function modelsListCommand(opts, runtime) {
	...
	const { ensureAuthProfileStore } = await import("./auth-profiles-CiQsARKp.js").then((n) => n.t);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-Db-28JMH.js").then((n) => n.t);
