...
import { C as parseDurationMs, i as loadConfig } from "./config-DtbRlmRZ.js";
import "./manifest-registry-C_GIiKba.js";
import "./runner-C7hM9HBS.js";
import "./image-D0vq23FW.js";
import { t as ensureOpenClawModelsJson } from "./models-config-D6nMAC_H.js";
...
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-Dm6Vfv5g.js";
...
import { i as resolveForwardCompatModel, r as ANTIGRAVITY_OPUS_46_FORWARD_COMPAT_CANDIDATES } from "./model-Cl0Gfh72.js";
...
import { n as runCommandWithRuntime, t as resolveOptionFromCommand } from "./cli-utils-BNQ6b6kn.js";
import "./help-format-Bnp4tZhj.js";
import { r as withProgressTotals } from "./progress-D_nB5v9p.js";
...
import { f as openUrl } from "./onboard-helpers-DZJJDjod.js";
...
import { t as createClackPrompter } from "./clack-prompter-Bv5b49ER.js";
...
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-BMDTdv9N.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-Tf6ZJ0Dn.js";
import { n as logConfigUpdated } from "./logging-C81FDh59.js";
import { a as createVpsAwareOAuthHandlers, c as githubCopilotLoginCommand, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-9tqaE_aA.js";
import { t as ensurePiAuthJsonFromAuthProfiles } from "./system-cli-B9KQ3FKH.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./config-DtbRlmRZ.js").then((n) => n.t);
	const { ensureAuthProfileStore } = await import("./model-selection-ynGV0Z-S.js").then((n) => n.ut);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-Cl0Gfh72.js").then((n) => n.t);
