...
import { Bt as loadOrCreateDeviceIdentity, Rt as normalizeFingerprint, jt as PROTOCOL_VERSION, n as formatGatewayPairingRequiredError, r as isPairingRequiredCloseReason, t as GatewayClient } from "./client-CnL59tOj.js";
...
import { c as pickPrimaryLanIPv4, r as isSecureWebSocketUrl } from "./net-COi3RSq7.js";
...
function formatGatewayCloseError(code, reason, connectionDetails) {
	...
	if (code === 1008 && isPairingRequiredCloseReason(reasonText)) return `${formatGatewayPairingRequiredError(reasonText)}\n${connectionDetails.message}`;
...
//#endregion
export { randomIdempotencyKey as a, authorizeOperatorScopesForMethod as c, loadGatewayTlsRuntime as d, ensureExplicitGatewayAuth as i, isNodeRoleMethod as l, callGateway as n, resolveExplicitGatewayAuth as o, callGatewayLeastPrivilege as r, ADMIN_SCOPE as s, buildGatewayConnectionDetails as t, resolveLeastPrivilegeOperatorScopesForMethod as u };