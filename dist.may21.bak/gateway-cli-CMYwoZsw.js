...
import { i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-BKnaiOKI.js";
import { l as isTestDefaultMemorySlotDisabled } from "./manifest-registry-DS2iK5AZ.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-DG_-cls5.js";
import { B as resolveSubagentMaxConcurrent, C as parseDurationMs, H as resolveRuntimeServiceVersion, N as applyMergePatch, P as applyLegacyMigrations, S as sensitive, V as VERSION, a as parseConfigJson5, c as resolveConfigSnapshotHash, d as OpenClawSchema, i as loadConfig, l as writeConfigFile, n as migrateLegacyConfig, o as readConfigFileSnapshot, r as createConfigIO, s as readConfigFileSnapshotForWrite, u as validateConfigObjectWithPlugins, z as resolveAgentMaxConcurrent } from "./config-BZ-sQEmh.js";
import { $ as validateNodePairApproveParams, A as validateCronRunParams, At as validateWizardStatusParams, B as validateExecApprovalRequestParams, C as validateConfigPatchParams, Ct as validateUpdateRunParams, D as validateCronAddParams, Dt as validateWizardCancelParams, E as validateConnectParams, Et as validateWebLoginWaitParams, F as validateDevicePairListParams, Ft as parseSessionLabel, G as validateExecApprovalsSetParams, H as validateExecApprovalsGetParams, Ht as verifyDeviceSignature, I as validateDevicePairRejectParams, It as buildDeviceAuthPayload, J as validateNodeDescribeParams, K as validateLogsTailParams, L as validateDevicePairRemoveParams, Lt as normalizeDeviceAuthScopes, M as validateCronStatusParams, Mt as ErrorCodes, N as validateCronUpdateParams, Nt as errorShape, O as validateCronListParams, Ot as validateWizardNextParams, P as validateDevicePairApproveParams, Q as validateNodeListParams, R as validateDeviceTokenRevokeParams, S as validateConfigGetParams, St as validateTalkModeParams, T as validateConfigSetParams, Tt as validateWebLoginStartParams, U as validateExecApprovalsNodeGetParams, V as validateExecApprovalResolveParams, Vt as normalizeDevicePublicKeyBase64Url, W as validateExecApprovalsNodeSetParams, X as validateNodeInvokeParams, Y as validateNodeEventParams, Z as validateNodeInvokeResultParams, _ as validateChatAbortParams, _t as validateSkillsBinsParams, a as validateAgentIdentityParams, at as validatePollParams, b as validateChatSendParams, bt as validateSkillsUpdateParams, c as validateAgentsCreateParams, ct as validateSendParams, d as validateAgentsFilesListParams, dt as validateSessionsListParams, et as validateNodePairListParams, f as validateAgentsFilesSetParams, ft as validateSessionsPatchParams, g as validateChannelsStatusParams, gt as validateSessionsUsageParams, h as validateChannelsLogoutParams, ht as validateSessionsResolveParams, i as formatValidationErrors, it as validateNodeRenameParams, j as validateCronRunsParams, jt as PROTOCOL_VERSION, k as validateCronRemoveParams, kt as validateWizardStartParams, l as validateAgentsDeleteParams, lt as validateSessionsCompactParams, m as validateAgentsUpdateParams, mt as validateSessionsResetParams, nt as validateNodePairRequestParams, o as validateAgentParams, ot as validatePushTestParams, p as validateAgentsListParams, pt as validateSessionsPreviewParams, q as validateModelsListParams, rt as validateNodePairVerifyParams, s as validateAgentWaitParams, st as validateRequestFrame, tt as validateNodePairRejectParams, u as validateAgentsFilesGetParams, ut as validateSessionsDeleteParams, v as validateChatHistoryParams, vt as validateSkillsInstallParams, w as validateConfigSchemaParams, wt as validateWakeParams, x as validateConfigApplyParams, xt as validateTalkConfigParams, y as validateChatInjectParams, yt as validateSkillsStatusParams, z as validateDeviceTokenRotateParams, zt as deriveDeviceIdFromPublicKey } from "./client-CnL59tOj.js";
import { n as pickPrimaryTailnetIPv4, r as pickPrimaryTailnetIPv6 } from "./tailnet-2NwZRUW_.js";
import { c as authorizeOperatorScopesForMethod, d as loadGatewayTlsRuntime$1, l as isNodeRoleMethod, n as callGateway, s as ADMIN_SCOPE$3 } from "./call-CUYAxKYv.js";
import { _ as normalizeGatewayClientMode, f as GATEWAY_CLIENT_CAPS, g as hasGatewayClientCap, h as GATEWAY_CLIENT_NAMES, i as isGatewayMessageChannel, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES, n as isDeliverableMessageChannel, p as GATEWAY_CLIENT_IDS, r as isGatewayCliClient, s as isWebchatClient, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-mz9U3AFl.js";
import { a as isValidIPv4, c as pickPrimaryLanIPv4, d as resolveGatewayListenHosts, f as resolveHostName, i as isTrustedProxyAddress, l as resolveGatewayBindHost, n as isLoopbackHost, o as normalizeHostHeader, p as rawDataToString, t as isLoopbackAddress, u as resolveGatewayClientIp } from "./net-COi3RSq7.js";
import { i as normalizeInputProvenance } from "./input-provenance-BPpmKfDN.js";
import { $n as resetAllLanes, At as applyBrowserProxyPaths, B as setCliSessionId, Bn as resolveTtsApiKey, Bt as setGatewaySigusr1RestartPolicy, Ct as stripLegacyDeliveryFields, Dt as detectSuspiciousPatterns, E as buildHistoryContextFromEntries, Et as buildSafeExternalPrompt, Ft as deferGatewayRestartUntilIdle, G as resolveAnnounceTargetFromKey, Gn as setTtsEnabled, Hn as resolveTtsConfig, Ht as normalizeGroupActivation, I as BARE_SESSION_RESET_PROMPT, In as resolveUserTimezone, It as emitGatewayRestart, J as resolveOutboundSessionRoute, Jn as OPENAI_TTS_MODELS, Kn as setTtsProvider, Ln as getTtsProvider, Lt as isGatewaySigusr1RestartExternallyAllowed, M as createReplyDispatcher, Mn as isAbortTrigger, N as getTotalPendingReplies, Nn as stopSubagentsForRequester, Ot as getHookType, Pt as consumeGatewaySigusr1RestartAuthorization, Q as resolveSessionDeliveryTarget, Qn as getTotalQueueSize, Qt as requestHeartbeatNow, R as resolveCronStyleNow, Rn as isTtsEnabled, Rt as markGatewaySigusr1RestartHandled, S as sleepWithAbort, Sn as resolveInputFileLimits, St as hasLegacyDeliveryHints, U as createOpenClawTools, Un as resolveTtsPrefsPath, V as runCliAgent, Vn as resolveTtsAutoMode, Vt as setPreRestartDeferralCheck, W as readLatestAssistantReply, Wn as resolveTtsProviderOrder, Wt as loadProviderUsageSummary, Xn as getActiveTaskCount, Yn as OPENAI_TTS_VOICES, Z as resolveOutboundTarget, _n as DEFAULT_INPUT_MAX_REDIRECTS, _t as normalizeOptionalText, a as runSubagentAnnounceFlow, at as formatDoctorNonInteractiveHint, b as requestBodyErrorToText, bn as extractImageContentFromSource, bt as migrateLegacyCronPayload, c as abortEmbeddedPiRun, cn as applyModelOverrideToSessionEntry, cr as clearAgentRunContext, ct as summarizeRestartSentinel, d as applyToolPolicyPipeline, dn as enqueueSystemEvent, dr as onAgentEvent, dt as normalizeHttpWebhookUrl, er as setCommandLaneConcurrency, et as resetDirectoryCache, f as buildDefaultToolPolicyPipelineSteps, fn as isSystemEventContextChanged, fr as registerAgentRunContext, ft as normalizeCronJobCreate, g as loadOpenClawPlugins, gn as DEFAULT_INPUT_IMAGE_MIMES, gt as normalizeOptionalSessionKey, hn as DEFAULT_INPUT_IMAGE_MAX_BYTES, ht as normalizeOptionalAgentId, it as consumeRestartSentinel, j as dispatchInboundMessage, jt as persistBrowserProxyFiles, kn as formatZonedTimestamp, kt as isExternalHookSession, l as getActiveEmbeddedRunCount, ln as applyVerboseOverride, lr as emitAgentEvent, m as getPluginToolMeta, mt as inferLegacyName, n as initSubagentRegistry, nn as resolveSendPolicy, nr as CommandLane, nt as runWithModelFallback, o as clearSessionQueues, ot as formatRestartSentinelMessage, pt as normalizeCronJobPatch, q as ensureOutboundSessionEntry, qn as textToSpeech, r as listDescendantRunsForRequester, rr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, s as runEmbeddedPiAgent, sr as stripHeartbeatToken, t as countActiveDescendantRuns, tn as normalizeSendPolicy, tr as waitForActiveTasks, u as waitForEmbeddedPiRunEnd, un as parseVerboseOverride, ur as getAgentRunContext, ut as writeRestartSentinel, v as handleSlackHttpRequest, vn as DEFAULT_INPUT_TIMEOUT_MS, vt as normalizePayloadToSystemText, wn as resolveAgentTimeoutMs, x as computeBackoff, xn as normalizeMimeList, xt as buildDeliveryFromLegacyPayload, y as readJsonBodyWithLimit, yn as extractFileContentFromSource, yt as normalizeRequiredName, z as getCliSessionId, zn as isTtsProviderConfigured, zt as scheduleGatewaySigusr1Restart } from "./subagent-registry-vEaOpKkF.js";
import { A as canonicalizeMainSessionAlias, B as cleanStaleLockFiles, C as evaluateSessionFreshness, H as deliveryContextFromSession, I as snapshotSessionOrigin, K as normalizeSessionDeliveryFields, M as resolveExplicitAgentSessionKey, N as resolveMainSessionKey, P as resolveMainSessionKeyFromConfig, T as resolveSessionResetPolicy, W as mergeDeliveryContext, _ as readSessionMessages, a as loadSessionStore, b as resolveSessionTranscriptCandidates, g as capArrayByJsonBytes, h as archiveSessionTranscripts, j as resolveAgentMainSessionKey, m as archiveFileOnDisk, n as parseSessionThreadInfo, t as extractDeliveryInfo, u as updateSessionStore, v as readSessionPreviewItemsFromTranscript, x as stripEnvelopeFromMessages } from "./sessions-DR2Q7emK.js";
...
import { t as buildChannelAccountBindings } from "./bindings-BD0BDrVW.js";
...
import { n as createBrowserRouteDispatcher, r as getMachineDisplayName } from "./with-timeout-C5wD-6xB.js";
import { C as getGlobalHookRunner, T as runGlobalGatewayStopSafely, o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads } from "./deliver-Ds1FsdFM.js";
import { d as startDiagnosticHeartbeat, f as stopDiagnosticHeartbeat, m as isDiagnosticsEnabled } from "./diagnostic-Bg3wFx-Z.js";
import "./diagnostic-session-state-DqgfGYqZ.js";
import "./accounts-Dnz84Cq6.js";
import "./send-CySDoLIX.js";
import { d as detectMime, n as openFileWithinRoot, t as SafeOpenError } from "./fs-safe-BY9kuZ3o.js";
import "./pi-embedded-helpers-CqzGUWmo.js";
import { g as collectExplicitAllowlist, x as resolveToolProfilePolicy, y as mergeAlsoAllowPolicy } from "./sandbox-DHahf6kq.js";
import { t as ToolInputError } from "./common-KSoAA9JF.js";
...
import { t as safeEqualSecret } from "./secret-equal-D-d0uTPY.js";
import { a as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, i as resolveGatewayAuth, n as authorizeGatewayConnect, o as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, r as isLocalDirectRequest, s as createAuthRateLimiter, t as assertGatewayAuthConfigured } from "./auth-Usar6LvN.js";
import { g as mergeGatewayTailscaleConfig, h as ensureGatewayStartupAuth } from "./server-context-D1WgVN1U.js";
import "./routes-PsuhHUg2.js";
import "./redact-ClDEZIsW.js";
import { a as isErrno, n as formatErrorMessage } from "./errors-BBDex6Nx.js";
import "./paths-CdSSbPPa.js";
import { t as SsrFBlockedError } from "./ssrf-Ixuyn7h8.js";
import "./store-CLY8B6p7.js";
import { i as formatPortDiagnostics, n as inspectPortUsage, t as ensurePortAvailable } from "./ports-Dq8ogiz4.js";
import { t as movePathToTrash } from "./trash-CWQQXWX3.js";
import "./dock-D6bGtL_y.js";
import "./accounts-DJ2NdTBm.js";
import { c as resolveStorePath, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveSessionTranscriptsDirForAgent } from "./paths-CHiHHmOl.js";
...
import { a as resolveAgentIdentity, t as createReplyPrefixOptions } from "./reply-prefix-B2KTDwI6.js";
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-Cus9od3R.js";
...
import { t as fetchWithSsrFGuard } from "./fetch-guard-DKnIywH2.js";
...
import { d as registerUnhandledRejectionHandler } from "./runner-CispZDn9.js";
import { n as loadModelCatalog } from "./model-catalog-pRYheRY6.js";
...
import { A as registerSkillsChangeListener, C as resolvePairingPaths, D as writeJsonAtomic, E as readJsonFile, S as pruneExpiredPending, T as createAsyncLock, _ as requestNodePairing, b as generatePairingToken, c as recordRemoteNodeInfo, d as removeRemoteNodeInfo, f as setSkillsRemoteRegistry, g as renamePairedNode, h as rejectNodePairing, k as getSkillsSnapshotVersion, l as refreshRemoteBinsForConnectedNodes, m as listNodePairing, o as getRemoteSkillEligibility, p as approveNodePairing, s as primeRemoteSkillsCache, u as refreshRemoteNodeBins, v as updatePairedNodeMetadata, w as upsertPendingPairingRequest, x as verifyPairingToken, y as verifyNodeToken } from "./skill-commands-D4KJCxgh.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-DVRmoVcd.js";
import "./pairing-store-BnNXa5t_.js";
import "./fetch-DhJ-elk8.js";
import { a as mergeExecApprovalsSocketDefaults, c as readExecApprovalsSnapshot, p as saveExecApprovals, r as ensureExecApprovals, s as normalizeExecApprovals, t as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-jec-Q4LG.js";
import "./nodes-screen-DacHCXz4.js";
import { c as hasNonzeroUsage, i as loadSessionUsageTimeSeries, n as loadCostUsageSummary, r as loadSessionCostSummary, s as deriveSessionTotalTokens, t as discoverAllSessions } from "./session-cost-usage-D3wNHCTs.js";
import { n as formatTokenCount, r as formatUsd } from "./usage-format-BzVVjHV2.js";
import { a as resolveSubagentToolPolicy, c as isRestartEnabled, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-BJuTD3zW.js";
import { n as createBrowserControlContext, r as startBrowserControlServiceFromConfig } from "./control-service-CvuxiESd.js";
...
import { n as resolveMessageChannelSelection } from "./channel-selection-WbeswRpE.js";
...
import { t as getChannelActivity } from "./channel-activity-DXoatCXN.js";
...
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-1IVAZXr5.js";
...
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-avAVO_ps.js";
import { n as inheritOptionFromParent } from "./command-options-CfGhT1Of.js";
import { t as buildChannelUiCatalog } from "./catalog-20G-EClO.js";
...
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-D69Yom3k.js";
import "./install-safe-path-BiSJziNV.js";
import "./skill-scanner-CFkJ9nj-.js";
import { t as buildChannelAccountSnapshot } from "./status-BtRY0nXQ.js";
...
import "./lifecycle-core-DujU3vyI.js";
import "./systemd-hints-D3ovjVua.js";
import { t as parsePort$1 } from "./parse-port-BQ0_YQqL.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-CTct7Kqo.js";
import "./diagnostics-DmGaiRdO.js";
import "./table-D01d2GuY.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-Bu_TALID.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-BT9law_v.js";
import { c as probeGateway, o as isNodeCommandAllowed, s as resolveNodeCommandAllowlist } from "./audit-D07-OGTR.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-x2FBX4kS.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-w3PKFZWH.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-BOYHVZ3d.js";
import { n as createDefaultDeps, r as createOutboundSendDeps$1, t as createOutboundSendDeps } from "./outbound-send-deps-C6hZ49as.js";
import { a as resolveControlUiRootSync, i as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-CEq_Smds.js";
import { a as resolveNpmChannelTag, c as DEFAULT_PACKAGE_CHANNEL, m as normalizeUpdateChannel, n as compareSemverStrings, t as checkUpdateStatus } from "./update-check-Kxb4dis0.js";
import { t as runOnboardingWizard } from "./onboarding-Bul3cilz.js";
import { a as sendApnsAlert, c as parseMessageWithAttachments, d as shouldLogWs, f as summarizeAgentEventForWsLog, i as resolveApnsAuthConfigFromEnv, l as formatForLog, n as normalizeApnsEnvironment, o as sendApnsBackgroundWake, p as setGatewayWsLogStyle, s as normalizeRpcAttachmentsToChatAttachments, t as loadApnsRegistration, u as logWs } from "./push-apns-BZyzK2u5.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-CNT8jOmB.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, s as loadAgentIdentityFromWorkspace, t as applyAgentConfig } from "./agents.config-DmNhTHHZ.js";
import { i as resolveAgentOutboundTarget, r as resolveAgentDeliveryPlan, t as agentCommand } from "./agent-Cr64r5QF.js";
...
import { t as installSkill } from "./skills-install-B8ZjTSsS.js";
import { n as runGatewayUpdate, t as resolveAgentSessionDirs } from "./session-dirs-CkM1jxzR.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-BbCKCKNZ.js";
import { n as forceFreePortAndWait } from "./ports-CEO1I5p5.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-C-SnEhm4.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-D3wNHCTs.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./control-service-CvuxiESd.js").then((n) => n.t);
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		...
		const { deliverOutboundPayloads } = await import("./deliver-Ds1FsdFM.js").then((n) => n.n);
