...
import { A as resolveUserPath, E as normalizeE164, L as truncateUtf16Safe, O as resolveConfigDir, ot as resolvePreferredOpenClawTmpDir, t as CHANNEL_IDS } from "./registry-NFGeyJJt.js";
import { i as resolveGatewayPort, t as STATE_DIR, u as resolveRequiredHomeDir } from "./paths-DJmOcr7Q.js";
import { $ as resolveProcessScopedMap, et as isPidAlive } from "./model-selection-lLjW3OfS.js";
import { V as parseDurationMs, a as writeConfigFile, n as loadConfig, s as parseByteSize, t as createConfigIO } from "./config-b_ZjXvb5.js";
import { d as extensionForMime, i as buildImageResizeSideGrid, l as resizeToJpeg, o as getImageMetadata, r as IMAGE_REDUCE_QUALITY_STEPS, u as detectMime } from "./fs-safe-B1_uPmaf.js";
import { i as defaultRuntime, t as createSubsystemLogger } from "./subsystem-D2OSuNEb.js";
import { E as runExec, _ as DEFAULT_TOOLS_FILENAME, d as DEFAULT_AGENTS_FILENAME, f as DEFAULT_AGENT_WORKSPACE_DIR, g as DEFAULT_SOUL_FILENAME, h as DEFAULT_IDENTITY_FILENAME, l as resolveSessionAgentId, m as DEFAULT_HEARTBEAT_FILENAME, n as resolveAgentConfig, p as DEFAULT_BOOTSTRAP_FILENAME, v as DEFAULT_USER_FILENAME, y as ensureAgentWorkspace } from "./agent-scope-BJVFRSpq.js";
import { d as sanitizeContentBlocksImages, u as wrapOwnerOnlyToolExecution } from "./common-1UfuNz24.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as safeEqualSecret, u as resolveSandboxPath } from "./skills-q6doMiiJ.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-DJtjmMEg.js";
import { t as SsrFBlockedError } from "./ssrf-3c0ma4wW.js";
import { A as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, C as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, D as DEFAULT_BROWSER_EVALUATE_ENABLED, E as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, O as DEFAULT_OPENCLAW_BROWSER_COLOR, S as stopChromeExtensionRelayServer, T as DEFAULT_AI_SNAPSHOT_MAX_CHARS, _ as fetchJson, a as resolveOpenClawUserDataDir, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, g as appendCdpPath, h as withBrowserNavigationPolicy, i as launchOpenClawChrome, j as isLoopbackHost, k as DEFAULT_OPENCLAW_BROWSER_ENABLED, l as createTargetViaCdp, m as assertBrowserNavigationAllowed, n as isChromeCdpReady, o as stopOpenClawChrome, p as InvalidBrowserNavigationUrlError, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as fetchOk, w as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, x as ensureChromeExtensionRelayServer } from "./chrome-RdW0oOkM.js";
import { i as parseBooleanValue, t as formatCliCommand } from "./command-format-xicngZGC.js";
import { A as normalizeHyphenSlug, d as getChannelDock, o as normalizeThinkLevel } from "./thinking-DZz2EesG.js";
import { t as normalizeChatType } from "./chat-type-3FRbbjbq.js";
import { r as normalizeChannelId } from "./plugins-CW-Dp-Ow.js";
import { a as listDeliverableMessageChannels, o as normalizeMessageChannel } from "./message-channel-3z1YKOtY.js";
import { n as resolveConversationLabel } from "./conversation-label-MLmUBidd.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-C32ZptcZ.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-C32ZptcZ.js")).closePlaywrightBrowserConnection();
		} catch {}
