...
import { B as resolveOpenClawAgentDir, T as resolveApiKeyForProvider, c as normalizeProviderId, h as normalizeGoogleModelId, w as requireApiKey } from "./model-selection-lLjW3OfS.js";
import { G as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, J as resolveIMessageAttachmentRoots, K as isInboundPathAllowed, n as loadConfig, q as mergeInboundPathRoots } from "./config-b_ZjXvb5.js";
import { f as getFileExtension, g as kindFromMime, m as isAudioFileName, u as detectMime } from "./fs-safe-B1_uPmaf.js";
import { E as runExec } from "./agent-scope-BJVFRSpq.js";
import { n as fetchWithTimeout } from "./fetch-timeout-IIHFohfs.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, o as fetchWithSsrFGuard, r as MediaFetchError } from "./local-roots-nnu8NE5F.js";
import { t as normalizeChatType } from "./chat-type-3FRbbjbq.js";
import { t as describeImageWithModel, x as ensureOpenClawModelsJson } from "./image-BIeEM4V_.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-D2PdChEW.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-Cw_zM1Fm.js").then((n) => n.r);
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-DNMrpkm4.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
