...
import { _ as runExec } from "./workspace-Dk7qkKmf.js";
import { G as resolveOpenClawAgentDir, T as resolveApiKeyForProvider, c as normalizeProviderId, h as normalizeGoogleModelId, w as requireApiKey } from "./model-selection-BymXpuGc.js";
import { t as normalizeChatType } from "./chat-type-C4pAlbsI.js";
import { f as getFileExtension, g as kindFromMime, m as isAudioFileName, u as detectMime } from "./fs-safe-D_arMs0S.js";
import { d as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, f as isInboundPathAllowed, m as resolveIMessageAttachmentRoots, n as loadConfig, p as mergeInboundPathRoots } from "./config-CUdAlGKZ.js";
import { S as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-ClJrgwhy.js";
import { n as collectProviderApiKeysForExecution, r as executeWithApiKeyRotation, t as parseGeminiAuth } from "./gemini-auth-BRIL0wJL.js";
import { n as fetchWithTimeout } from "./fetch-timeout-DL3f_O53.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, o as fetchWithSsrFGuard, r as MediaFetchError } from "./local-roots-C_Ncbu0N.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-In9hsGQO.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
